      ...
      >
        ...
        {!hasPermission && (
          <GlassCard
            ...
            radius="lg"
            padding="sm"
            style={[styles.permissionWarning, styles.glassShadow]}
          >
        ...
        {weather ? (
          ...
          >
            <GlassCard
              ...
              radius="lg"
              padding="md"
              style={[styles.windInfoBar, styles.glassShadow]}
            >
          ...
          <GlassCard
            ...
            radius="lg"
            padding="md"
            style={[styles.noWeatherBar, styles.glassShadow]}
          >
        ...
        <GlassCard
          ...
          radius="lg"
          padding="lg"
          style={[styles.distanceSection, styles.glassShadow]}
        >
